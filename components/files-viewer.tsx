...
import { InlineQASheet } from "@/components/inline-qa-sheet";
import { RemixSheet } from "@/components/remix-sheet";
...
export function FilesViewer() {
  ...
  const [remixDialog, setRemixDialog] = useState<{
    open: boolean;
    docIds: string[];
    docNames: string[];
  }>({ open: false, docIds: [], docNames: [] });
  ...
  return (
    ...
    >
                      ...
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="top">
                            Remix into roadmaps, decks & more
                          </TooltipContent>
                        </Tooltip>
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        Transform into build plans, decks & more
                      </TooltipContent>
                    </Tooltip>
      ...
      <RemixSheet
        docIds={remixDialog.docIds}
        docNames={remixDialog.docNames}
        docType="files"
        onOpenChange={(open) => {
          setRemixDialog((prev) => ({ ...prev, open }));
          if (!open) {
            exitSelectMode();
          }
        }}
